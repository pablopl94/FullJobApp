...
/**
 * Esta clase permite que Spring Security cargue los datos de un usuario
 ...
 * 3. Si el usuario existe pero está desactivado (enabled = 0), también se lanza una excepción.
 * 4. Si todo está bien, se obtiene su rol (por ejemplo: CLIENTE, EMPRESA, ADMON).
 * 5. Se crea un objeto `User` de Spring Security con el email, la contraseña y el rol con prefijo `ROLE_`.
 * 
